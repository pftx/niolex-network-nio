 ...
 */
@Component
public class UpdateConfigHandler implements IPacketHandler {
	...
	public void handleRead(PacketData sc, IPacketWriter wt) {
		...
		String r = groupService.updateItem(item, wt);
		String s = StringUtil.concat(",", item.getKey(), r);
		wt.handleWrite(new PacketData(CodeMap.RES_UPDATE_ITEM, s));
	}
