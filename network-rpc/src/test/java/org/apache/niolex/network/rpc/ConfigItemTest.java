...
public class ConfigItemTest {
	...
	public void testConfigItem() {
		...
		item.setInterface(getClass());
		assertEquals(getClass(), item.getInterface());
	}
	...
	public void testGetInterface() {
		ConfigItem item = new ConfigItem(getClass(), "Good");
		assertEquals("Good", item.getTarget());
	}
	...
	public void testGetTarget() {
		ConfigItem item = new ConfigItem();
		item.setTarget(this);
		assertEquals(this, item.getTarget());
	}
